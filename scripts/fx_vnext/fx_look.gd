...
static func field_meta() -> Dictionary:
	return {
		...
		"mono_mode": {"kind": "option", "options": ["HARD", "BAYER", "NOISE", "RANDOM", "CHECKER", "INVERSE"]},
		"mono_bayer_level": {"kind": "int", "min": 0.0, "max": 2.0, "step": 1.0},
		...
		"dither_mode": {"kind": "option", "options": ["FLAT", "BAYER", "NOISE", "RANDOM", "CHECKER", "RADIAL"]},
		"dither_bayer_level": {"kind": "int", "min": 0.0, "max": 2.0, "step": 1.0},
...
static func field_meta_more() -> Dictionary:
	return {
		...
		"fringe_coverage_mode": {"kind": "option", "options": ["SMOOTH", "BAYER", "NOISE", "RANDOM", "CHECKER", "RADIAL"]},
		"fringe_coverage_threshold": {"kind": "amount", "min": 0.0, "max": 1.0, "step": 0.01},
		"fringe_bayer_level": {"kind": "int", "min": 0.0, "max": 2.0, "step": 1.0},
